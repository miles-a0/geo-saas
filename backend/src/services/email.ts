      ...
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #F3F4F6; border-radius: 12px; padding: 20px; margin: 24px 0; text-align: center;">
          ...
          <p style="color: #6B7280; font-size: 14px; margin-top: 8px;">
            The full PDF report has been attached to this email for your convenience.
          </p>
        </div>
        
        <p style="color: #6B7280; font-size: 14px;">
          This report will also be available in your dashboard for 12 months.
        </p>
...
export async function sendEmail(params: {
  ...
  const { to, template, data, attachment } = params;
